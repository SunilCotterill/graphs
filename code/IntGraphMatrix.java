...
/**
 * This class represents a graph stored using an adjacency matrix.
 * 
 * @author Mark Hancock
...
public class IntGraphMatrix extends IntGraph {
	/**
	 * The adjacency matrix for this graph (represented as a 2D array).
	 */
	 ...
	 * @throws IllegalArgumentException always, since adjacency matrices have
	 *                                  nodes created at initialization and more
	 ...
	 * 
	 * @throws IllegalArgumentException if either first or second are outside
	...
	public List<Integer> getAdjacencyList(int v) {
		...
		// for testing.
		return IntStream.range(0, getNumVertices()).filter(i -> adjMatrix[v][i])
	...
	public Set<Integer> getVertices() {
		...
		// this is just some nice clean code to do something useful
		// for testing.
		return IntStream.range(0, getNumVertices()).boxed()
